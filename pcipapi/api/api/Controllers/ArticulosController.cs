...
namespace api.Controllers
{
    ...
    public class ArticulosController : ControllerBase
    {
        ...
        private ILogger<ArticulosController> _logger;

        public ArticulosController(ILogger<ArticulosController> logger, IWorkRepository unit)
        {
            this._unit = unit;
            this._logger = logger;
        }
        ...
        [SwaggerOperation(
            Summary = "Consulta",
            Description = "Consulta información sobre un articulo en especifico.",
            OperationId = "GetArticulo",
            Tags = new[] { "Catálogo operativo", "Articulos", "Consulta" })]
        ...
        public async Task<IActionResult> GetArticulo([FromRoute, SwaggerParameter(description: "Identificador interno del articulo.", Required = true)] int id)
        {
            try
            {
                var resultado = await _unit.Articulo.GetByIdAsync(id).ConfigureAwait(false);
        ...
        [SwaggerOperation(
            ...
            Tags = new[] { "Catálogo operativo", "Articulos", "Listado" })]
        [SwaggerResponse(200, "Articulos", typeof(ResponseModel<List<ArticuloViewModel>>))]
        [SwaggerResponse(400, "Solicitud incorrecta", typeof(Error400))]
        [SwaggerResponse(401, "Accedo denegado. Token inválido", typeof(Error401))]
        [SwaggerResponse(500, "Error interno en el servidor", typeof(Error500))]
        [Produces("application/json")]
        public async Task<IActionResult> GetArticulos()
        {
            ...
            {
                return Problem(detail: ex.Message, instance: HttpContext.Request.Path, statusCode: 500, title: "Listado de articulos");
            }
        }
        ...
        [SwaggerOperation(
                ...
                Tags = new[] { "Catálogo operativo", "Articulos", "Agregar" })]
        [SwaggerResponse(200, "Articulo", typeof(ResponseModel<ArticuloViewModel>))]
        [SwaggerResponse(400, "Solicitud incorrecta", typeof(Error400))]
        [SwaggerResponse(401, "Accedo denegado. Token inválido", typeof(Error401))]
        [SwaggerResponse(500, "Error interno en el servidor", typeof(Error500))]
        ...
        [SwaggerOperation(
            ...
            Tags = new[] { "Catálogo operativo", "Articulos", "Actualizar" })]
        [SwaggerResponse(200, "Articulo", typeof(ResponseModel<ArticuloViewModel>))]
        [SwaggerResponse(400, "Solicitud incorrecta", typeof(Error400))]
        [SwaggerResponse(401, "Accedo denegado. Token inválido", typeof(Error401))]
        [SwaggerResponse(500, "Error interno en el servidor", typeof(Error500))]
        ...
        [SwaggerOperation(
            ...
            Tags = new[] { "Catálogo operativo", "Articulos", "Eliminar" })]
        [SwaggerResponse(200, "Articulo", typeof(ResponseModel<ArticuloViewModel>))]
        [SwaggerResponse(400, "Solicitud incorrecta", typeof(Error400))]
        [SwaggerResponse(401, "Accedo denegado. Token inválido", typeof(Error401))]
        [SwaggerResponse(500, "Error interno en el servidor", typeof(Error500))]
