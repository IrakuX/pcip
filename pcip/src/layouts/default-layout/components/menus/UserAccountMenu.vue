  ...
  <div
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start"
      ...
      <div class="menu-sub menu-sub-dropdown w-175px py-4">
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a @click="setLang('en')" href="#" class="menu-link d-flex px-5"
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a @click="setLang('es')" href="#" class="menu-link d-flex px-5"
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a @click="setLang('de')" href="#" class="menu-link d-flex px-5"
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a @click="setLang('ja')" href="#" class="menu-link d-flex px-5"
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a @click="setLang('fr')" href="#" class="menu-link d-flex px-5"
