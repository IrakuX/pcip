<template>
  <!--begin::Aside-->
  <div id="kt_aside" class="aside overflow-visible bg-primary" data-kt-drawer="true" data-kt-drawer-name="aside"
...
import { asideTheme } from "@/layouts/default-layout/config/helper";
