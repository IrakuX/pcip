  ...
  <div class="card mb-10">
    ...
    <div class="card-header card-header-stretch">
      <ul class="nav nav-stretch nav-line-tabs fw-semibold border-0" role="tablist" id="kt_layout_builder_tabs"
        ...
        <li class="nav-item">
          <a class="nav-link cursor-pointer" :class="{ active: tabIndex === 0 }" data-bs-toggle="tab"
            @click="setActiveTab($event)" data-tab-index="0" role="tab">
            Main
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link cursor-pointer" :class="{ active: tabIndex === 1 }" data-bs-toggle="tab"
            @click="setActiveTab($event)" data-tab-index="1" role="tab">
            Header
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link cursor-pointer" :class="{ active: tabIndex === 2 }" data-bs-toggle="tab"
            @click="setActiveTab($event)" data-tab-index="2" role="tab">
            Subheader
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link cursor-pointer" :class="{ active: tabIndex === 4 }" data-bs-toggle="tab"
            @click="setActiveTab($event)" data-tab-index="4" role="tab">
            Content
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link cursor-pointer" :class="{ active: tabIndex === 5 }" data-bs-toggle="tab"
            @click="setActiveTab($event)" data-tab-index="5" role="tab">
            Footer
          </a>
        </li>
      </ul>
    ...
    <form class="form" id="kt_layout_builder_form" @submit="submit($event)">
      ...
      <div class="card-body">
        <div class="tab-content pt-3" id="kt_tabs">
          <div class="tab-pane" :class="{ active: tabIndex === 0 }" id="kt_builder_main">
            <!--begin::Form group-->
            ...
            <!--end::Separator-->
            <div class="row mb-10">
              <label class="col-lg-3 col-form-label text-lg-end">Illustration Set:</label>
                    ...
                    <label
                      ...
                      <span class="d-flex mb-2">
                        <span class="form-check form-check-custom form-check-solid form-check-sm me-5">
                          <input class="form-check-input" type="radio" v-model="config.illustrations.set"
                            value="sketchy-1" name="illustrations-set" id="sketchy-1" />
                        </span>
                      ...
                      }" class="d-block h-200px w-100 bgi-no-repeat bgi-size-contain bgi-position-center"></span>
                    </label>
                  </div>
                  <div class="col-6">
                    <label
                      ...
                      <span class="d-flex mb-2">
                        <span class="form-check form-check-custom form-check-solid form-check-sm me-5">
                          <input class="form-check-input" type="radio" v-model="config.illustrations.set"
                            value="sigma-1" name="illustrations-set" id="sigma-1" />
                        </span>
                  ...
                  <div class="col-6">
                    <label
                      ...
                      <span class="d-flex mb-2">
                        <span class="form-check form-check-custom form-check-solid form-check-sm me-5">
                          <input class="form-check-input" type="radio" v-model="config.illustrations.set"
                            value="dozzy-1" name="illustrations-set" id="dozzy-1" />
                        </span>
                  ...
                  <div class="col-6">
                    <label
                      ...
                      <span class="d-flex mb-2">
                        <span class="form-check form-check-custom form-check-solid form-check-sm me-5">
                          <input class="form-check-input" type="radio" v-model="config.illustrations.set"
                            value="unitedpalms-1" name="illustrations-set" id="unitedpalms-1" />
                        </span>
          ...
          <div class="tab-pane" :class="{ active: tabIndex === 1 }" id="kt_builder_header">
            <div class="row mb-10">
              ...
              <div class="col-lg-9 col-xl-4">
                ...
                <input type="hidden" v-model="config.header.fixed.tabletAndMobile" />

                <label class="form-check form-check-custom form-check-solid form-switch mb-5">
                  <input class="form-check-input" type="checkbox" v-model="config.header.fixed.desktop" />
                  <span class="form-check-label text-muted">Desktop</span>
                </label>

                <label class="form-check form-check-custom form-check-solid form-switch mb-5">
                  <input class="form-check-input" type="checkbox" v-model="config.header.fixed.tabletAndMobile" />
            ...
            <div class="row mb-10">
              <label class="col-lg-3 col-form-label text-lg-end">Menu Icon:</label>
              <div class="col-lg-9 col-xl-4">
                <select class="form-select form-select-solid" v-model="config.header.menuIcon">
            ...
            <div class="row mb-10">
              ...
              <div class="col-lg-9 col-xl-4">
                <select class="form-select form-select-solid" v-model="config.header.width">
          ...
          <div class="tab-pane" :class="{ active: tabIndex === 2 }" id="kt_builder_subheader">
            <div class="row mb-10">
              ...
              <div class="col-lg-9 col-xl-4">
                ...
                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                  <input class="form-check-input" type="checkbox" v-model="config.toolbar.display" value="true" />
                </div>
            ...
            <div class="row mb-10">
              <label class="col-lg-3 col-form-label text-lg-end">Width:</label>
              <div class="col-lg-9 col-xl-4">
                <select class="form-select form-select-solid" v-model="config.toolbar.width">
                  <option value="fluid">Fluid</option>
                  <option value="fixed">Fixed</option>
                </select>
                <div class="form-text text-muted">
          ...
          <div class="tab-pane" :class="{ active: tabIndex === 4 }" id="kt_builder_content">
            <div class="row mb-10">
              <label class="col-lg-3 col-form-label text-lg-end">Width:</label>
              <div class="col-lg-9 col-xl-4">
                <select class="form-select form-select-solid" v-model="config.content.width">
                  <option value="fluid">Fluid</option>
                  <option value="fixed">Fixed</option>
                </select>
                <div class="form-text text-muted">
          ...
          <div class="tab-pane" :class="{ active: tabIndex === 5 }" id="kt_builder_footer">
            <div class="row mb-10">
              <label class="col-lg-3 col-form-label text-lg-end">Width:</label>
              <div class="col-lg-9 col-xl-4">
                <select class="form-select form-select-solid" v-model="config.footer.width">
                  <option value="fluid">Fluid</option>
                  <option value="fixed">Fixed</option>
                </select>
                <div class="form-text text-muted">
