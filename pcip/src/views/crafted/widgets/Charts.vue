<template>
  ...
  <div class="row g-5 g-xl-8">
    <div class="col-xl-6">
      <ChartsWidget1 widget-classes="card-xl-stretch mb-xl-8" :height="400"></ChartsWidget1>
    </div>
    <div class="col-xl-6">
      <ChartsWidget2 widget-classes="card-xl-stretch mb-xl-8" :height="400"></ChartsWidget2>
    </div>
  </div>
  <!--end::Row-->
